<template>
  <div class="container">
    <div id="productlist" class="row row-cols-md-4">
      <div v-for="product in products" class="col mb-4 mr-4 p-0" v-bind:key="product">
...
.product-card:hover div.cart-icon a,
.product-card:hover div.cart-icon span {
  color: rgb(19, 172, 0);
  border-color: rgb(19, 172, 0);
}
div.cart-icon span {
  color: white;
  font-size: 20px;
}
.product-card:hover div.cart-icon:hover span,
.product-card:hover div.cart-icon:hover a {
  color: white;
